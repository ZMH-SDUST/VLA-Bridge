...
def main(args):
    ...
    args.human_idx = 0 
    dataset = DataFactory(name=args.dataset, partition=args.partitions[1], data_root=args.data_root, clip_model_name=args.clip_model_name)
    ...
    upt = build_detector(args, conversion, object_n_verb_to_interaction=object_n_verb_to_interaction, clip_model_path=args.clip_dir_vit, num_anno = 117)
    upt = upt.cuda()
    upt.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--zs', action='store_true', default=False)  ## zero-shot
    ...
    parser.add_argument('--LA_weight', default=0.6, type=float)

    parser.add_argument('--feat_mask_type', type=int, default=0, )
    parser.add_argument('--num_classes', type=int, default=117, )
    parser.add_argument('--prior_method', type=int, default=0)
    parser.add_argument('--vis_prompt_num', type=int, default=50)
    parser.add_argument('--box_proj', type=int, default=0, )
